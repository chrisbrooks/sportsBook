...
(function() {
    ...
    function a(c, d) {
        ...
        if (b) {
            c.addEventListener("mouseover", this.onMouse, true);
            c.addEventListener("mousedown", this.onMouse, true);
            c.addEventListener("mouseup", this.onMouse, true);
        }
        c.addEventListener("click", this.onClick, true);
        c.addEventListener("touchstart", this.onTouchStart, false);
        c.addEventListener("touchmove", this.onTouchMove, false);
        c.addEventListener("touchend", this.onTouchEnd, false);
        c.addEventListener("touchcancel", this.onTouchCancel, false);
        if (!Event.prototype.stopImmediatePropagation) {
            c.removeEventListener = function(a, b, d) {
                var e = Node.prototype.removeEventListener;
                if (a === "click") {
                    e.call(c, a, b.hijacked || b, d);
                } else {
                    e.call(c, a, b, d);
                }
            };
            c.addEventListener = function(a, b, d) {
                ...
                if (a === "click") {
                    e.call(c, a, b.hijacked || (b.hijacked = function(a) {
    ...
    var c = /iP(ad|hone|od)/.test(navigator.userAgent);
    var d = c && /OS 4_\d(_\d)?/.test(navigator.userAgent);
    var e = c && /OS ([6-9]|\d{2})_\d/.test(navigator.userAgent);
    var f = navigator.userAgent.indexOf("BB10") > 0;
    ...
    a.prototype.determineEventType = function(a) {
        if (b && a.tagName.toLowerCase() === "select") {
            return "mousedown";
        }
        return "click";
    };
    a.prototype.focus = function(a) {
        var b;
        if (c && a.setSelectionRange && a.type.indexOf("date") !== 0 && a.type !== "time" && a.type !== "month") {
            b = a.value.length;
    ...
    a.prototype.onTouchEnd = function(a) {
        ...
        if (h === "label") {
            ...
            if (a.timeStamp - g > 100 || c && window.top !== window && h === "input") {
                this.targetElement = null;
                return false;
            }
            this.focus(k);
...
(function(a, b, c) {
    ...
    function f(a, c) {
        this.wrapper = typeof a == "string" ? b.querySelector(a) : a;
    ...
    f.prototype = {
        ...
        _start: function(a) {
            ...
            var b = a.touches ? a.touches[0] : a, d;
        ...
        scrollTo: function(a, b, c, d) {
            ...
            if (!c || this.options.useTransition && d.style) {
        ...
        _transitionTime: function(a) {
            ...
            if (!a && e.isBadAndroid) {
                this.scrollerStyle[e.style.transitionDuration] = "0.001s";
            }
            if (this.indicators) {
    ...
    function h(c, d) {
        this.wrapper = typeof d.el == "string" ? b.querySelector(d.el) : d.el;
    ...
    h.prototype = {
        ...
        transitionTime: function(a) {
            ...
            if (!a && e.isBadAndroid) {
                this.indicatorStyle[e.style.transitionDuration] = "0.001s";
            }
        },
...
var Handlebars = function() {
    ...
    var e = function(a, b, c) {
        ...
        function j(a, b) {
            ...
            var c = function(a, c, d, e, g, h) {
                var i = b.VM.invokePartial.apply(this, arguments);
                if (i != null) {
                    return i;
                }
                if (b.compile) {
                    ...
                    throw new f("The partial " + c + " could not be compiled when running in runtime-only mode");
                }
            };
            var d = {
            ...
            return function(c, e) {
                e = e || {};
                var f = e.partial ? e : b, g, h;
                if (!e.partial) {
                    g = e.helpers;
                    h = e.partials;
                }
                var i = a.call(d, f, c, g, h, e.data);
                if (!e.partial) {
                    b.VM.checkRevision(d.compilerInfo);
                }
                return i;
            };
        }
    ...
    var g = function(a) {
        ...
        var e = {
            ProgramNode: function(a, b, c, f) {
                ...
                if (c) {
                    ...
                    if (h) {
                        ...
                        this.inverse = new e.ProgramNode(c, b, g);
                    } else {
                        this.inverse = new e.ProgramNode(c, b);
                    }
                    this.strip.right = b.left;
                } else if (b) {
                    this.strip.left = b.right;
                }
            },
            ...
            SexprNode: function(a, b, c) {
                ...
                var g = this.eligibleHelper = e.isSimple;
                this.isHelper = g && (f.length || b);
            },
            PartialNode: function(a, b, c, e) {
                d.call(this, e);
                this.type = "partial";
                this.partialName = a;
                this.context = b;
            ...
            BlockNode: function(a, b, e, f, g) {
                d.call(this, g);
                if (a.sexpr.id.original !== f.path.original) {
                ...
                (b || e).strip.left = a.strip.right;
                (e || b).strip.right = f.strip.left;
                if (e && !b) {
                    this.isInverse = true;
                }
            },
    ...
    var h = function() {
        ...
        var b = function() {
            var a = {
                ...
                performAction: function f(a, c, d, e, g, h, i) {
                    var j = h.length - 1;
                    switch (g) {
                      case 1:
                        return new e.ProgramNode(h[j - 1], this._$);
                        break;
                      ...
                      case 3:
                        this.$ = new e.ProgramNode([], h[j - 1], h[j], this._$);
                        break;

                      case 4:
                        this.$ = new e.ProgramNode(h[j - 2], h[j - 1], h[j], this._$);
                        break;
                      ...
                      case 6:
                        this.$ = new e.ProgramNode(h[j], this._$);
                        break;
                      ...
                      case 11:
                        this.$ = new e.BlockNode(h[j - 2], h[j - 1].inverse, h[j - 1], h[j], this._$);
                        break;

                      case 12:
                        this.$ = new e.BlockNode(h[j - 2], h[j - 1], h[j - 1].inverse, h[j], this._$);
                        break;
                      ...
                      case 15:
                        this.$ = new e.ContentNode(h[j], this._$);
                        break;

                      case 16:
                        this.$ = new e.CommentNode(h[j], this._$);
                        break;

                      case 17:
                        this.$ = new e.MustacheNode(h[j - 1], null, h[j - 2], b(h[j - 2], h[j]), this._$);
                        break;
                      ...
                      case 22:
                        this.$ = new e.PartialNode(h[j - 2], h[j - 1], b(h[j - 3], h[j]), this._$);
                        break;
                      ...
                      case 24:
                        this.$ = new e.SexprNode([ h[j - 2] ].concat(h[j - 1]), h[j], this._$);
                        break;

                      case 25:
                        this.$ = new e.SexprNode([ h[j] ], null, this._$);
                        break;
                      ...
                      case 27:
                        this.$ = new e.StringNode(h[j], this._$);
                        break;

                      case 28:
                        this.$ = new e.IntegerNode(h[j], this._$);
                        break;

                      case 29:
                        this.$ = new e.BooleanNode(h[j], this._$);
                        break;
                      ...
                      case 32:
                        this.$ = new e.HashNode(h[j], this._$);
                        break;
                      ...
                      case 34:
                        this.$ = new e.PartialNameNode(h[j], this._$);
                        break;

                      case 35:
                        this.$ = new e.PartialNameNode(new e.StringNode(h[j], this._$), this._$);
                        break;

                      case 36:
                        this.$ = new e.PartialNameNode(new e.IntegerNode(h[j], this._$));
                        break;

                      case 37:
                        this.$ = new e.DataNode(h[j], this._$);
                        break;

                      case 38:
                        this.$ = new e.IdNode(h[j], this._$);
                        break;
    ...
    var i = function(a, b) {
        ...
        c.parser = d;
        function f(a) {
            if (a.constructor === e.ProgramNode) {
                return a;
            }
            d.yy = e;
            return d.parse(a);
    ...
    var j = function(a) {
        ...
        d.prototype = {
            ...
            helperSexpr: function(a, b, d) {
                var e = this.setupFullMustacheParams(a, b, d), f = a.id.parts[0];
                if (this.options.knownHelpers[f]) {
                    this.opcode("invokeKnownHelper", e.length, f);
                } else if (this.options.knownHelpersOnly) {
                    throw new c("You specified knownHelpersOnly, but used the unknown helper " + f, a);
                } else {
                    this.opcode("invokeHelper", e.length, f, a.isRoot);
                }
            },
            sexpr: function(a) {
            ...
            DATA: function(a) {
                ...
                if (a.id.isScoped || a.id.depth) {
                    throw new c("Scoped data references are not supported: " + a.original, a);
                }
                this.opcode("lookupData");
                var b = a.id.parts;
                for (var d = 0, e = b.length; d < e; d++) {
                    this.opcode("lookup", b[d]);
                }
            },
            STRING: function(a) {
        ...
        function e(a, b, d) {
            if (a == null || typeof a !== "string" && a.constructor !== d.AST.ProgramNode) {
                throw new c("You must pass a string or Handlebars AST to Handlebars.precompile. You passed " + a);
            }
            b = b || {};
            if (!("data" in b)) {
                b.data = true;
            ...
            var e = d.parse(a);
            var f = new d.Compiler().compile(e, b);
            return new d.JavaScriptCompiler().compile(f, b);
        }
        b.precompile = e;
        function f(a, b, d) {
            if (a == null || typeof a !== "string" && a.constructor !== d.AST.ProgramNode) {
                throw new c("You must pass a string or Handlebars AST to Handlebars.compile. You passed " + a);
            }
            b = b || {};
            if (!("data" in b)) {
                b.data = true;
            ...
            function f() {
                var c = d.parse(a);
                var e = new d.Compiler().compile(c, b);
                var f = new d.JavaScriptCompiler().compile(e, b, undefined, true);
                return d.template(f);
            }
            return function(a, b) {
                if (!e) {
    ...
    var k = function(a, b) {
        ...
        i.prototype = {
            nameLookup: function(a, b) {
                var c, d;
                if (a.indexOf("depth") === 0) {
                    c = true;
                }
                if (/^[0-9]+$/.test(b)) {
                    d = a + "[" + b + "]";
                } else if (i.isValidJavaScriptVariableName(b)) {
                    d = a + "." + b;
                } else {
                    d = a + "['" + b + "']";
                }
            ...
            compile: function(a, b, c, d) {
                this.environment = a;
                this.options = b || {};
                f("debug", this.environment.disassemble() + "\n\n");
                ...
                var e = a.opcodes, h;
                this.i = 0;
                for (var i = e.length; this.i < i; this.i++) {
                    h = e[this.i];
                    if (h.opcode === "DECLARE") {
                        this[h.name] = h.value;
                    } else {
                    ...
                    if (h.opcode !== this.stripNext) {
                        this.stripNext = false;
                    }
                }
                this.pushSource("");
                if (this.stackSlot || this.inlineStack.length || this.compileStack.length) {
                    throw new g("Compile completed with content left on stack");
                }
            ...
            createFunctionContext: function(a) {
                ...
                var d = this.isChild ? [ "depth0", "data" ] : [ "Handlebars", "depth0", "helpers", "partials", "data" ];
                for (var e = 0, g = this.environment.depths.list.length; e < g; e++) {
                    d.push("depth" + this.environment.depths.list[e]);
                }
                var h = this.mergeSource();
                if (!this.isChild) {
                    h = this.compilerInfo() + h;
                }
                if (a) {
                    d.push(h);
            ...
            mergeSource: function() {
                var a = "", b;
                for (var c = 0, d = this.source.length; c < d; c++) {
                    var e = this.source[c];
                    if (e.appendToBuffer) {
                        if (b) {
                            b = b + "\n    + " + e.content;
            ...
            invokeHelper: function(a, b, c) {
                ...
                var d = this.lastHelper = this.setupHelper(a, b, true);
                var e = this.nameLookup("depth" + this.lastContext, b, "context");
                var f = "helper = " + d.name + " || " + e;
                if (d.paramsInit) {
                    f += "," + d.paramsInit;
                }
            ...
            replaceStack: function(a) {
                var b = "", c = this.isInline(), d, e, f;
                if (c) {
                    var g = this.popStack(true);
                    if (g instanceof h) {
                        d = g.value;
                        f = true;
                    } else {
                        e = !this.stackSlot;
                        var i = !e ? this.topStackName() : this.incrStack();
                        b = "(" + this.push(i) + " = " + g + "),";
                        d = this.topStack();
                    }
                } else {
            ...
            setupHelper: function(a, b, c) {
                var d = [], e = this.setupParams(a, d, c);
            ...
            setupOptions: function(a, b) {
                ...
                if (this.options.stringParams) {
                    c.push("hashTypes:" + this.popStack());
        ...
        var j = ("break else new var" + " case finally return void" + " catch for switch while" + " continue function this with" + " default if throw" + " delete in try" + " do instanceof typeof" + " abstract enum int short" + " boolean export interface static" + " byte extends long super" + " char final native synchronized" + " class float package throws" + " const goto private transient" + " debugger implements protected volatile" + " double import public let yield").split(" ");
        var k = i.RESERVED_WORDS = {};
        for (var l = 0, m = j.length; l < m; l++) {
            k[j[l]] = true;
        }
        i.isValidJavaScriptVariableName = function(a) {
            if (!i.RESERVED_WORDS[a] && /^[a-zA-Z_$][0-9a-zA-Z_$]*$/.test(a)) {
                return true;
            }
            return false;
        };
...
(function(a, b, c) {
    ...
    d.init = function() {
        function d(a) {
            var b = JSON.parse(localStorage.getItem(a)), c, d, g, h;
            if (b) {
                c = new Date();
                d = new Date(b.storedTime);
                g = c - d;
                h = Math.round(g % 864e5 % 36e5 / 6e4);
            }
            if (b && h < 10) {
                f(b);
            } else {
        ...
        function e(a) {
            b.ajax({
                type: "POST",
                url: "http://content.guardianapis.com/search?api-key=5vk4jfy7myw4rdgfhg2hx7tn&show-fields=all&order-by=newest&section=" + a + "",
                dataType: "JSONP",
                success: function(c) {
                    c.storedTime = new Date();
                    localStorage.setItem(a, JSON.stringify(c));
                    if (b("ul.tabs li").hasClass("current")) {
                        f(c);
                    }
                },
                beforeSend: function() {
                    b("body").append(b("<div class='loading'/>"));
                    b(".loading").fadeIn();
                },
                complete: function() {
                    b(".loading").remove();
        ...
        function g(a, b, c) {
            ...
            var e = c[b].webPublicationDate, f = new Date(e), g = f.getDate() + " " + d[f.getMonth()] + " " + f.getFullYear();
            c[b].newDate = g;
            var h = c[b].webPublicationDate, i = new Date(h), j = ("0" + i.getHours()).slice(-2) + "." + ("0" + i.getMinutes()).slice(-2);
            c[b].newTime = j;
        }
        function h(d) {
            b(".story").on("click", function() {
                var e = b(this).index(), f = d.response.results[e], g = f.fields.body, h = f.fields.trailText, i = f.webTitle;
                if (c !== g && g.length > 100) {
                    b(".full-story").append("<div class='generalpic'></div><h1 class='currentHeadline'>" + i + "</h1><div class='currentTrailText'>" + h + "</div><div class='currentStory'>" + g + "</div>").addClass("opened");
                    b(".content-wrapper, .menu, .back").addClass("opened");
                } else {
                    var j = b(this).find("a");
                    j.attr("target", "_blank");
                    a.open(j.attr("href"));
                }
                if (b(".twitter-tweet").length > 0) {
                    if (typeof twttr != "undefined") {
                        twttr.widgets.load();
                    } else {
                        b.getScript("http://platform.twitter.com/widgets.js");
                    }
                }
            });
        }
        function i(a) {
            var c = b("#headlines-success").html(), d = Handlebars.compile(c), e = d(a);
            b(".tab-content.current .news-story").append(e);
        }
        function j(a) {
            var c = a.attr("data-tab");
            b("ul.tabs li").removeClass("current");
            b(".tab-content").removeClass("current");
            a.addClass("current");
            b("#" + c).addClass("current");
            var e = a.attr("data-role");
            if (b("#" + c).find(".story").length < 1 && a.hasClass("current")) {
                d(e);
            }
            b(".header p.sportstitle").empty();
            b(".header p.sportstitle").append(a.find("p").html());
        }
        b(document).ready(function() {
            d("news");
            b(".menu, ul li").on("click", function() {
                b("nav, .menu, .content-wrapper, .full-story").toggleClass("active");
            });
            b(".back").on("click", function() {
                b(".content-wrapper, .full-story, .menu, .back").toggleClass("opened");
                setTimeout(function() {
                    b(".full-story").empty();
                }, 500);
            });
            b("ul.tabs li").on("click", function() {
                var a = b(this);
                j(a);
                b(".sports-title").empty();
                b(".sports-title").append(b(this).find("p").html());
            });
        });
    };
    d.init();
