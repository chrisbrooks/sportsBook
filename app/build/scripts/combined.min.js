...
(function(a, b, c) {
    ...
    d.init = function() {
        function d(a) {
            ...
            if (b) {
                var i = b.response.results;
                for (var j = 0; j < i.length; j += 1) {
                    if (i[j].fields.liveBloggingNow === "true" && h > 0) {
                        e(a);
                    }
                }
            }
        ...
        function e(a) {
            b.ajax({
                type: "POST",
                url: "http://content.guardianapis.com/search?api-key=5vk4jfy7myw4rdgfhg2hx7tn&show-fields=all&order-by=newest&q=" + a + "&ion=sport",
                dataType: "JSONP",
                success: function(c) {
        ...
        function j(a) {
            ...
            b(".header p.sportstitle").append(a.find("p").html() + " News");
        }
        b(document).ready(function() {
            d("sport");
            b(".menu, ul li").on("click", function() {
                b("ul, .menu, .content-wrapper, .full-story").toggleClass("active");
            });
            ...
            b("ul.tabs li").on("click", function() {
                ...
                b(".sports-title").append(b(this).find("p").html() + " News");
            });
        });
    };
    d.init();
